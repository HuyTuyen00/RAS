...
{
    [TestFixture]
    public class Policy : BaseAutomationTest
    {
        ...
        public void Test01_Create()
        {
            ...
            driver.GotoUrl("/AdminArea/Policy");

            driver.FindWebElement(By.XPath("//a[text()='Thêm mới']")).Click();
            Thread.Sleep(1000);

            var txtRoleName = driver.FindWebElement(By.Id("PolicyContent"));

            Random rnd = new Random();
            var RoleName = "Chính Sách _" + rnd.Next(100000, 999999999);
        ...
        public void Test04_Delete()
        {
            ...
            if (isExist != null)
            {
                ...
                isExist.FindElement(By.XPath(".//button[@class='btn btn-warning btn-circle']")).Click();
                Thread.Sleep(1000);
