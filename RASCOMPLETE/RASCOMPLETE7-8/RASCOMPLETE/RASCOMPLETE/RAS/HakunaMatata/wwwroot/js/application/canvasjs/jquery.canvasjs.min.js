...
(function () {
    ...
    function P(h) {
        var m = ((h & 16711680) >> 16).toString(16), B = ((h & 65280) >> 8).toString(16);
    ...
    function eb(h, m) {
        ...
        for (0 > r && (r += B); r < B; r++) if (r in this && this[r] === h) return r;
        return -1
    }
    ...
    function J(h, m) {
        ...
        }[h || "solid"]) for (var r = 0; r < B.length; r++) B[r] *= m; else B = [];
        return B
    }

    function K(h, m, B, w, ta) {
        w = w || [];
        ta = r(ta) ? gb ? {passive: !1, capture: !1} : !1 : ta;
        w.push([h, m, B, ta]);
        return h.addEventListener ? (h.addEventListener(m, B, ta), B) : h.attachEvent ? (w = function (m) {
            m = m || window.event;
    ...
    function hb(h) {
        if (h._menuButton) h.exportEnabled ?
            ...
            }), La(h._menuButton), h._menuButton.title = h._cultureInfo.menuText) : ua(h._menuButton); else if (h.exportEnabled && w) {
            var m = !1;
        ...
        if (h.exportEnabled && h._dropdownMenu) {
            ...
            for (var B = h._dropdownMenu.childNodes, r = [h._cultureInfo.printText, h._cultureInfo.saveJPGText, h._cultureInfo.savePNGText], ta = 0; ta < B.length; ta++) W(B[ta], {
                backgroundColor: h.toolbar.itemBackgroundColor,
                color: h.toolbar.fontColor
            }), B[ta].innerHTML = r[ta]
        ...
        }, h.allDOMEventHandlers, !0), B = document.createElement("div"), W(B, {padding: "12px 8px 12px 8px"}), B.innerHTML = h._cultureInfo.printText, B.style.backgroundColor = h.toolbar.itemBackgroundColor, B.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(B),
            K(B, "touchstart", function (h) {
                m = !0
            ...
            h.print();
            ua(h._dropdownMenu)
        }, h.allDOMEventHandlers, !0), B = document.createElement("div"), W(B, {padding: "12px 8px 12px 8px"}),
            ...
            ua(h._dropdownMenu)
        }, h.allDOMEventHandlers, !0), B = document.createElement("div"), W(B, {padding: "12px 8px 12px 8px"}), B.innerHTML = h._cultureInfo.savePNGText, B.style.backgroundColor = h.toolbar.itemBackgroundColor, B.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(B), K(B, "touchstart", function (h) {
            m = !0
        }, h.allDOMEventHandlers), K(B, "mousemove", function () {
    ...
    function Za(h, m, B) {
        ...
        m = !0;
        for (B = 0; 4 > B; B++) if (h[B] !== h[B + 4] | h[B] !== h[B + 8] | h[B] !== h[B + 12]) {
            m = !1;
            break
        }
        return m ?
    ...
    function ib(h) {
        if (!jb) {
            var m = !1, B = !1;
            h.creditHref = "https://fptshop.com.vn/"; // https://fptshop.com.vn/
            h.creditText = "RAS.com"
    ...
    function va(h, m, B) {
        ...
        B && (m.setAttribute("state", B), m.setAttribute("type", "button"), W(m, {
            padding: "5px 12px",
            cursor: "pointer",
            "float": "left",
            width: "40px",
            ...
            lineHeight: "0"
        }), m.setAttribute("title", h._cultureInfo[B + "Text"]), m.innerHTML = "<img src='" + kb[B].image + "' alt='" + h._cultureInfo[B + "Text"] + "' />", W(m.childNodes[0], {
            height: "95%",
            pointerEvents: "none"
        }))
    }
    ...
    function V(h, m, B, w, v) {
        ...
        this.themeOptions = h;
        this.options = B ? B : {_isPlaceholder: !0};
    ...
    var Ha = !1, U = {}, w = !!document.createElement("canvas").getContext, qa = {
            Chart: {
                width: 500,
                height: 400,
                zoomEnabled: !1,
        ...
        Ka = {en: {}}, v = w ? "Trebuchet MS, Helvetica, sans-serif" : "Arial",
        Fa = w ? "Impact, Charcoal, sans-serif" : "Arial", za = {
    ...
    (function () {
        ...
        U.pro = {sCH: qa[U.fSDec("Bi`su")][U.fSDec("bsdehuIsdg")]};
        U._fTWm =
            function (h) {
                if ("undefined" === typeof U.pro.sCH && !cb) try {
                    var m, r = h[U.fSDec("buy")];
                    ...
                    r[U.fSDec("ghmmUdyu")](U.fSDec("B`ow`rKR!Ush`m"),
                        0, m)
                } catch (w) {
                }
            }
    ...
    var gb = function () {
            ...
            return function (E, J, O) {
                var R = O ? O.days : m, P = O ? O.months : w, K = O ? O.shortDays : r, I = O ? O.shortMonths : v;
                O = "";
                var U = !1;
                ...
                O = U ? "getUTC" : "get";
                var W = E[O + "Date"](), N = E[O + "Day"](),
                    ba = E[O + "Month"](), a = E[O + "FullYear"](), d = E[O + "Hours"](), c = E[O + "Minutes"](),
                    b = E[O + "Seconds"](), e = E[O + "Milliseconds"](), f = U ? 0 : E.getTimezoneOffset();
            ...
            var w = 0 > h ? !0 : !1;
            w && (h *= -1);
            var v = r ? r.decimalSeparator : ".", S = r ? r.digitGroupSeparator : ",", A = "";
            m = String(m);
            var A = 1, E = r = "", J = -1, O = [], R = [], P = 0, K = 0, I = 0, U = !1, W =
                0, E = m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
            m = null;
            for (var N = 0; E && N < E.length; N++) if (m = E[N], "." === m && 0 > J) J = N; else {
            ...
            U && (m = Math.floor(h), E = -Math.floor(Math.log(h) / Math.LN10 + 1), W = 0 === h ? 0 : 0 === m ? -(P + E) :
                String(m).length - P, A /= Math.pow(10, W));
            0 > J && (J = N);
            A = (h * A).toFixed(K);
            m = A.split(".");
            A = (m[0] + "").split("");
            h = (m[1] + "").split("");
            A && "0" === A[0] && A.shift();
            for (U = E = N = K = J = 0; 0 < O.length;) if (m = O.pop(), "#" === m || "0" === m) if (J++, J === P) {
                var ba = A, A = [];
                if ("0" === m) for (m = P - K - (ba ? ba.length : 0); 0 < m;) ba.unshift("0"), m--;
                for (; 0 < ba.length;) r = ba.pop() + r, U++, 0 === U % E && (N === I && 0 < ba.length) && (r = S + r)
            } else 0 < A.length ? (r = A.pop() + r, K++, U++) : "0" === m && (r = "0" + r, K++, U++), 0 === U % E && (N === I && 0 < A.length) && (r = S + r); else "E" !== m[0] && "e" !== m[0] ||
            "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? "," === m ? (N++, E = U, U = 0, 0 < A.length && (r = S + r)) : r = 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? m.slice(1, m.length - 1) + r : m + r : (m = 0 > W ? m.replace("+", "").replace("-", "") : m.replace("-", ""), r += m.replace(/[0]+/, function (a) {
                return Z(W, a.length)
            }));
            S = "";
            for (O = !1; 0 < R.length;) m = R.shift(), "#" === m || "0" === m ? 0 < h.length && 0 !== Number(h.join("")) ? (S += h.shift(), O = !0) : "0" === m && (S += "0", O = !0) : 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] &&
                "'" === m[m.length - 1]) ? S += m.slice(1, m.length - 1) : "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? S += m : (m = 0 > W ? m.replace("+", "").replace("-", "") : m.replace("-", ""), S += m.replace(/[0]+/, function (a) {
                return Z(W, a.length)
            }));
            r += (O ? v : "") + S;
            return w ? "-" + r : r
            ...
            return {x: m, y: r}
        }, $a = !0, Ra = window.devicePixelRatio ||
            ...
            h.restore();
            !0 === P && (h.save(), h.beginPath(), h.moveTo(m, r), h.lineTo(m + I, r + I), h.lineTo(w - I, r + I), h.lineTo(w, r), h.closePath(),
                A = h.createLinearGradient((w + m) / 2, r + I, (w + m) / 2, r), A.addColorStop(0, E), A.addColorStop(1, "rgba(255, 255, 255, .4)"), h.fillStyle = A, h.fill(), h.restore());
            ...
            !0 === R && (h.save(), h.beginPath(), h.moveTo(m, r), h.lineTo(m + I, r + I), h.lineTo(m + I, v - I), h.lineTo(m, v),
                h.closePath(), A = h.createLinearGradient(m + I, (v + r) / 2, m, (v + r) / 2), A.addColorStop(0, E), A.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle = A, h.fill(), h.restore());
        ...
        jb = cb && -1 === window[ia("mnb`uhno")].href.indexOf(ia("gheemd")), kb = {
    ...
    V.prototype.updateOption = function (h) {
        ...
        var m = qa[this._defaultsKey], w = {}, v = this[h], E = this._themeOptionsKey,
            S = this._index;
    ...
    ja.prototype.render = function (h) {
        if (0 !== this.fontSize) {
            ...
            var w = 0, v = this.topPadding, E = null;
    ...
    ja.prototype._getLineWithWidth = function (h, m, r) {
        ...
        var w = r = 0, v = h.length - 1, E = Infinity;
        for (this.ctx.font = this._getFontString(); w <= v;) {
            var E = Math.floor((w + v) / 2), A = h.substr(0, E + 1);
    ...
    ja.prototype._wrapText = function () {
        var h = new String(Ga(String(this.text))), m = [], r = this.ctx.font, w = 0, v = 0;
        this.ctx.font = this._getFontString();
        if (0 === this.frontSize) v = w = 0; else for (; 0 < h.length;) {
            ...
            m.push(A);
            var J = v, v = Math.max(v, A.width), w = w + A.height, h = Ga(h.slice(A.text.length, h.length));
            E && w > E && (A = m.pop(), w -= A.height, v = J)
        }
        this._wrappedText = {lines: m, width: v, height: w};
    ...
    ya.prototype.setLayout = function () {
        if (this.text) {
            var h = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, m = h.layoutManager.getFreeSpace(),
                w = m.x1, v = m.y1, E = 0, J = 0,
                A = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, I, K;
            ...
            O = J.measureText();
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (v = m.y1 + 2, K = "top") : "bottom" === this.verticalAlign && (v = m.y2 - 2 - O.height, K = "bottom"), "left" === this.horizontalAlign ? w = m.x1 + 2 : "center" === this.horizontalAlign ? w = m.x1 + m.width / 2 - O.width / 2 : "right" === this.horizontalAlign &&
    ...
    v = Pa.Chart = function () {
        ...
        function m(a, d, c) {
            d = d || {};
            r(c) ?
                (this.predefinedThemes = bb, this.optionsName = this.parent = this.index = null) : (this.parent = c.parent, this.index = c.index, this.predefinedThemes = c.predefinedThemes, this.optionsName = c.optionsName, this.stockChart = c.stockChart, this.panel = a, this.isOptionsInArray = c.isOptionsInArray);
            ...
            (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ?
                (this.container.innerHTML = "", d = a = 0, a = this.options.width ? this.width : 0 < this.container.clientWidth ? this.container.clientWidth : this.width, d = this.options.height ? this.height : 0 < this.container.clientHeight ? this.container.clientHeight : this.height, this.width = a, this.height = d, this.x1 = this.y1 = 0, this.x2 = this.width, this.y2 = this.height, this.selectedColorSet = "undefined" !== typeof za[this.colorSet] ? za[this.colorSet] : za.colorSet1, this._canvasJSContainer = document.createElement("div"), this._canvasJSContainer.setAttribute("class",
                    ...
                    this.overlaidCanvasCtx.textBaseline = "top", Ca(this.overlaidCanvasCtx)), this._eventManager = new ha(this), this.windowResizeHandler = K(window, "resize", function () {
        ...
        function v(a, d) {
            for (var c = [], b, e = 0; e < a.length; e++) if (0 == e) c.push(a[0]); else {
                ...
                b = Math.abs((a[l].x - a[f].x) / (0 === a[l].x - a[s].x ? 0.01 :
                    a[l].x - a[s].x)) * (d - 1) / 2 + 1;
                var D = (a[l].x - a[f].x) / b;
                b = (a[l].y - a[f].y) / b;
        ...
        function E(a, d, c, b, e, f, l, s, D, k) {
            ...
            a.beginPath();
            D && 0 < s.thickness ? (a.moveTo(b - l.thickness / 2, Math.round((c + e) / 2) - p), a.lineTo(d + l.thickness / 2, Math.round((c + e) / 2) - p)) :
        ...
        m.prototype._updateOptions = function () {
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                ...
                this._resetButton ? (W(this._resetButton, {
                    ...
                    this.toolbar.buttonBorderColor, this._toolBar.appendChild(this._resetButton), K(this._resetButton, "touchstart", function (a) {
                    d = !0
                    ...
                    a.zoomEnabled || a.panEnabled ? (a.zoomEnabled = !0, a.panEnabled = !1, va(a, a._zoomButton, "pan"), a._defaultCursor = "default", a.overlaidCanvas.style.cursor = a._defaultCursor) : (a.zoomEnabled = !1, a.panEnabled =
                        !1);
                    ...
                    if (a.sessionVariables.axisY) for (b = 0; b < a.sessionVariables.axisY.length; b++) a.sessionVariables.axisY[b].newViewportMinimum = null, a.sessionVariables.axisY[b].newViewportMaximum =
                        null;
                    ...
                    K(this._resetButton, "mousemove", function () {
                        d || (W(a._resetButton, {
                            backgroundColor: a.toolbar.itemBackgroundColorOnHover,
        ...
        m.prototype.renderElements = function () {
            ...
            for (d = 0; d < this.plotInfo.plotTypes.length; d++) for (var f = this.plotInfo.plotTypes[d], l = 0; l < f.plotUnits.length; l++) {
                ...
                s.targetCanvas = null;
                this.animatedRender && (s.targetCanvas = sa(this.width, this.height), s.targetCanvasCtx = s.targetCanvas.getContext("2d"), e = s.targetCanvasCtx.miterLimit, s.targetCanvasCtx.miterLimit = 3);
        ...
        m.prototype._processStackedPlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d =
                    ...
                    var p = this.data[a.dataSeriesIndexes[n]], q = 0, g = !1, t = !1, h;
        ...
        m.prototype._processStacked100PlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = !1, s = !1, D = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
                    var n =
                        this.data[a.dataSeriesIndexes[k]], p = 0, q = !1, g = !1, t;
        ...
        m.prototype._processMultiYPlotUnit = function (a) {
            if (a.dataSeriesIndexes &&
                ...
                var k = this.data[a.dataSeriesIndexes[D]], n = 0, p = !1, q = !1, g, t, h;
                ...
                for (n = 0; n < k.dataPoints.length; n++) {
                    ...
                    if ((e = k.dataPoints[n].y) && e.length) {
                        ...
                        t = !0;
                        for (var r = 0; r < e.length; r++) null === e.k && (t = !1);
                        t && (p || (h = g), g = b)
                    }
                    b < c.min && (c.min = b);
                    b > c.max && (c.max = b);
                    ...
                    if (!(b < m) || p) {
                        ...
                        b < c.viewPortMin && (c.viewPortMin = b);
                        b > c.viewPortMax && (c.viewPortMax = b);
                        if (c.viewPortMin === b && e) for (r = 0; r < e.length; r++) if (null === e[r] && g < b) {
                            c.viewPortMin =
                                g;
                            break
                        }
        ...
        m.prototype._processSpecificPlotUnit = function (a) {
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                var s = this.data[a.dataSeriesIndexes[l]], D = 0, k = !1, n = !1, p = b = 0;
                ...
                for (D = 0; D < s.dataPoints.length; D++) if ("undefined" ===
        ...
        m.prototype.calculateAutoBreaks = function () {
            ...
            function d(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    if (b || c) for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, l = f.min, k = f.max, n = d.min, p = d.max, f = f._dataRanges, d = d._dataRanges, q, s = 0, D = 0; D < a.dataSeriesIndexes.length; D++) {
                        ...
                        if (!(4 > h.dataPoints.length)) for (s = 0; s < h.dataPoints.length; s++) if (b && (q = (k + 1 - l) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, g = h.dataPoints[s].x.getTime ? h.dataPoints[s].x.getTime() : h.dataPoints[s].x, q = Math.floor((g - l) / q), g < f[q].min &&
                        (f[q].min = g), g > f[q].max && (f[q].max = g)), c) {
                            var m = (p + 1 - n) * Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold) || 10, 10) / 100;
                            if ((g = "waterfall" === a.type ? h.dataPointEOs[s].cumulativeSum : h.dataPoints[s].y) && g.length) for (var w = 0; w < g.length; w++) q = Math.floor((g[w] - n) / m), g[w] < d[q].min && (d[q].min = g[w]), g[w] > d[q].max && (d[q].max = g[w]); else r(g) || (q = Math.floor((g - n) / m), g < d[q].min && (d[q].min = g), g > d[q].max && (d[q].max = g))
                        }
                    }
                }
            }
            ...
            function c(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks &&
                    ...
                    if (!(4 > n.dataPoints.length)) for (l = 0; l < n.dataPoints.length; l++) g = (d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, b = n.dataPoints[l].x.getTime ? n.dataPoints[l].x.getTime() : n.dataPoints[l].x, g = Math.floor((b - c) / g), b < f[g].min && (f[g].min = b), b > f[g].max && (f[g].max =
                        b)
                }
            }
            ...
            if (f) {
                ...
                for (l = 0; l < this._axes.length; l++) if (this._axes[l].dataInfo._dataRanges) {
                    ...
                    if (this._axes[l].dataInfo.dataPointYNegativeSums) {
                        ...
                        n = k;
                        for (s in q) q.hasOwnProperty(s) && !isNaN(s) && (p = -1 * q[s], r(p) || (g = Math.floor((p - D) / b), p < n[g].min && (n[g].min = p), p > n[g].max && (n[g].max = p)));
                        delete this._axes[l].dataInfo.dataPointYNegativeSums
                    }
                    for (s = 0; s < k.length - 1; s++) if (n = k[s].max, isFinite(n)) for (; s < k.length - 1;) if (D = k[s + 1].min, isFinite(D)) {
                        p = D - n;
                        p > b && f.push({diff: p, start: n, end: D});
                        break
                    } else s++;
                    if (this._axes[l].scaleBreaks.customBreaks) for (s = 0; s < this._axes[l].scaleBreaks.customBreaks.length; s++) for (b =
        ...
        m.prototype._mouseEventHandler = function (a) {
            ...
            if (this.interactivityEnabled) if (this._ignoreNextEvent) this._ignoreNextEvent = !1; else if (a.preventManipulation && a.preventManipulation(), a.preventDefault && a.preventDefault(), Ha && window.console && (window.console.log(c + " --\x3e x: " + d.x + "; y:" + d.y), e && window.console.log(a.which),
        ...
        m.prototype._plotAreaMouseUp = function (a, d) {
            if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
                ...
                if ("xySwapped" === this.plotInfo.axisPlacement) var s = f, f = e, e = s;
            ...
            if ("none" !== this.plotInfo.axisPlacement) {
                ...
                if (this.axisY && 0 < this.axisY.length) for (l = 0; l < this.axisY.length; l++) this.axisY[l].crosshair &&
                ...
                if (this.axisX2 && 0 < this.axisX2.length) for (l = 0; l < this.axisX2.length; l++) this.axisX2[l].crosshair && this.axisX2[l].crosshair.enabled &&
            ...
            if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
                ...
                if (2 < Math.abs(c) && 8 > Math.abs(c) && (this.panEnabled || this.zoomEnabled)) {
                    ...
                    for (var s = 0; s < this.axisX.length; s++) this.axisX[s].crosshair && this.axisX[s].crosshair.enabled && (this.axisX[s].crosshair.hide(), this.axisX[s].crosshair.dispatchEvent("hidden",
                        {chart: this, axis: this.axisX[s].options}, this.axisX[s].crosshair));
        ...
        m.prototype.validateRegion = function (a, d, c, b, e) {
            e = e || !1;
            for (var f = 0 <= this.zoomType.indexOf("x"), l = 0 <= this.zoomType.indexOf("y"), s = !1, D = [], k = [], n = [], p = 0; p < this._axes.length; p++) ("axisX" === this._axes[p].type &&
            ...
            for (l = 0; l < k.length; l++) {
                ...
                if (q > g) var t = g, g = q, q = t;
                if (p.scaleBreaks) for (t = 0; !f && t < p.scaleBreaks._appliedBreaks.length; t++) f = p.scaleBreaks._appliedBreaks[t].startValue <= q && p.scaleBreaks._appliedBreaks[t].endValue >= g;
                if (isFinite(p.dataInfo.minDiff)) if (t = p.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) &&
                    (p.logarithmic && t < Math.pow(p.dataInfo.minDiff, 3) || !p.logarithmic && t < 3 * Math.abs(p.dataInfo.minDiff)) || q < p.minimum || g > p.maximum)) D.push(p), n.push({
                    val1: q,
                    val2: g
                }), s = !0; else if (!e) {
                    s = !1;
        ...
        m.prototype.renderIndexLabels = function (a) {
            var d = a || this.plotArea.ctx, c = this.plotArea,
                b = 0, e = 0, f = 0, l = f = e = 0, s = 0, D = b = 0, k = 0;
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                var m = ma("indexLabelLineDashType", n.dataPoint, n.dataSeries),
                    ...
                    x = {percent: null, total: null}, z = null;
                ...
                if (null !== G && "" !== G) {
                    var x = ma("indexLabelPlacement", n.dataPoint, n.dataSeries),
                        ...
                        C = ma("indexLabelTextAlign", n.dataPoint, n.dataSeries), v = n.direction,
                        e = n.dataSeries.axisX, f = n.dataSeries.axisY, A = !1, h = new ja(d, {
                            x: 0,
                            y: 0,
                    ...
                    if ("normal" ===
                        ...
                        "inside" !== x ? (e = c.y1, f = c.y2, 0 < v ? (g = n.point.y + ("horizontal" === z ? t / 2 : 0) - k - s - b, g < e && (g = "auto" === x ? Math.max(n.point.y, e) + t / 2 + s : e + t / 2 + s, A = g + k > n.point.y)) : (g = n.point.y + t / 2 + s + b, g > f - k && (g = "auto" === x ? Math.min(n.point.y, f) + t / 2 - k - s : f + t / 2 - k, A = g < n.point.y))) : (e = Math.max(n.bounds.y1,
                    ...
                    p ? 0 > v ? Math.max(n.bounds.x1, c.x1) + t / 2 + l : Math.min(n.bounds.x2, c.x2) - D / 2 - l + ("horizontal" === z ? 0 : t / 2) : (Math.max(n.bounds.x1, c.x1) + Math.min(n.bounds.x2, c.x2)) / 2 + ("horizontal" === z ? 0 : t / 2), q = 0 > v ? Math.max(n.point.x, b) - ("horizontal" === z ? D / 2 : 0) : Math.min(n.point.x, b) - D / 2, q = Math.max(q, e));
                    "vertical" === z && (g += k - t / 2);
                    h.x = q;
                    h.y = g;
                    h.render(!0);
                    y && ("inside" !== x && (0 > p.indexOf("bar") && ("error" !== p || !n.axisSwapped) && n.point.x > c.x1 && n.point.x < c.x2 || !A) && (0 > p.indexOf("column") && ("error" !== p || n.axisSwapped) && n.point.y > c.y1 &&
            ...
            for (a = 0; a < this._indexLabels.length; a++) n = this._indexLabels[a], h = ma("indexLabelBackgroundColor", n.dataPoint, n.dataSeries), n.dataSeries.indexLabelBackgroundColor = r(h) ? w ? "transparent" : null : h;
            return d
        };
        m.prototype.renderLine = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], l, s = 0; s < a.dataSeriesIndexes.length; s++) {
                    var D = a.dataSeriesIndexes[s], k = this.data[D];
                    c.lineWidth = k.lineThickness;
                    var n = k.dataPoints, p = "solid";
                    if (c.setLineDash) {
                        var q = J(k.nullDataLineDashType, k.lineThickness), p = k.lineDashType,
                    ...
                    var t = k._colorSet, h = t = k.lineColor = k.options.lineColor ? k.options.lineColor : t[0];
                    c.strokeStyle = t;
                    var m = !0, u = 0, r, x;
                    c.beginPath();
                    if (0 < n.length) {
                        for (var z = !1, u = 0; u < n.length; u++) if (r = n[u].x.getTime ? n[u].x.getTime() : n[u].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !z))) if ("number" !== typeof n[u].y) 0 < u && !(k.connectNullData || z || m) && (c.stroke(), w && b.stroke()), z =
                            ...
                            m || z ? (!m && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), p = k.nullDataLineDashType, c.setLineDash(q)), c.lineTo(r, x), w && b.lineTo(r, x)) : (c.beginPath(), c.moveTo(r, x), w && (b.beginPath(),
                                b.moveTo(r, x))), z = m = !1) : (c.lineTo(r, x), w && b.lineTo(r, x), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(r, x), w && (b.stroke(), b.beginPath(), b.moveTo(r, x))));
                            l = {x: r, y: x};
        ...
        m.prototype.renderStepLine = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], l, s = 0; s < a.dataSeriesIndexes.length; s++) {
                    ...
                    var t =
                        k.id;
                    this._eventManager.objectMap[t] = {objectType: "dataSeries", dataSeriesIndex: D};
                    t = P(t);
                    b.strokeStyle = t;
                    b.lineWidth = 0 < k.lineThickness ? Math.max(k.lineThickness, 4) : 0;
                    var t = k._colorSet, h = t = k.lineColor = k.options.lineColor ? k.options.lineColor : t[0];
                    ...
                    if (0 < n.length) {
                        ...
                        u && !(k.connectNullData || z || m) && (c.stroke(), w && b.stroke()), z = !0; else {
                            ...
                            m || z ? (!m && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), p = k.nullDataLineDashType, c.setLineDash(q)),
                                c.lineTo(r, G), c.lineTo(r, x), w && (b.lineTo(r, G), b.lineTo(r, x))) : (c.beginPath(), c.moveTo(r, x), w && (b.beginPath(), b.moveTo(r, x))), z = m = !1) : (c.lineTo(r, G), w && b.lineTo(r, G), c.lineTo(r, x), w && b.lineTo(r, x), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(r, x), w && (b.stroke(), b.beginPath(), b.moveTo(r, x))));
                            l = {x: r, y: x};
                            u < n.length - 1 && (h !== (n[u].lineColor || t) || p !== (n[u].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(r, x), h = n[u].lineColor || t, c.strokeStyle = h, c.setLineDash && (n[u].lineDashType ? (p = n[u].lineDashType,
        ...
        m.prototype.renderSpline = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var l = [], s = 0; s < a.dataSeriesIndexes.length; s++) {
                    ...
                    var r = 0, u, m, x = [];
                    b.beginPath();
                    if (0 < n.length) for (m = !1, r = 0; r < n.length; r++) if (u = n[r].getTime ? n[r].x.getTime() : n[r].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !m))) if ("number" !== typeof n[r].y) 0 < r && !m && (k.connectNullData ? b.setLineDash && (0 < x.length && (k.options.nullDataLineDashType || !n[r - 1].lineDashType)) && (x[x.length - 1].newLineDashArray = q, p = k.nullDataLineDashType) :
                        (d(x), x = [])), m = !0; else {
                        ...
                        x[x.length] = {x: u, y: m};
                        r < n.length - 1 && (h !== (n[r].lineColor || t) || p !== (n[r].lineDashType || k.lineDashType)) && (h = n[r].lineColor || t, x[x.length - 1].newStrokeStyle = h, b.setLineDash && (n[r].lineDashType ? (p = n[r].lineDashType, x[x.length - 1].newLineDashArray = J(p, k.lineThickness)) : (p = k.lineDashType,
        ...
        m.prototype.renderColumn = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, l, s, D,
                ...
                for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var q = a.dataSeriesIndexes[n], g = this.data[q], t = g.dataPoints;
                    if (0 < t.length) for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < t.length; f++) if (t[f].getTime ? D = t[f].x.getTime() :
                        ...
                        ea(c, a.axisX.reversed ? r : l, s, a.axisX.reversed ?
                        ...
                        (t[f].indexLabel || g.indexLabel || t[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                            ...
                            dataPoint: t[f],
                            dataSeries: g,
                            point: {x: l + (r - l) / 2, y: 0 > t[f].y === a.axisY.reversed ? s : u},
                            direction: 0 > t[f].y === a.axisY.reversed ? 1 : -1,
                            bounds: {x1: l, y1: Math.min(s, u), x2: r, y2: Math.max(s, u)},
                            color: b
                        })
                    }
                }
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++) if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                            ...
                            (u[k].indexLabel || r.indexLabel || u[k].indexLabelFormatter ||
                                ...
                                bounds: {x1: n, y1: Math.min(p, z), x2: x, y2: Math.max(p, z)},
                                color: b
                            })
                        }
                    }
        ...
        m.prototype.renderStackedColumn100 = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx :
                d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = [], l = [], s = [], D = [], k = 0, n, p,
                    q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                    k = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
                    g = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.15 * this.width << 0,
                    t = a.axisX.dataInfo.minDiff;
                ...
                for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                    var h = a.dataSeriesIndexes[g], r = this.data[h], u = r.dataPoints;
                    if (0 < u.length) for (var m = 5 < t && r.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++) if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                        n = a.axisX.convertValueToPixel(b);
                        ...
                        b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length];
                        ea(c, n, a.axisY.reversed ? z : p, x, a.axisY.reversed ? p : z, b, 0, null, m && (a.axisY.reversed ? 0 > u[k].y : 0 <= u[k].y), (a.axisY.reversed ? 0 <= u[k].y : 0 > u[k].y) &&
                            m, !1, !1, r.fillOpacity);
                        b = r.dataPointIds[k];
                        this._eventManager.objectMap[b] = {
                            id: b,
        ...
        m.prototype.renderBar = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var q =
                        a.dataSeriesIndexes[n], g = this.data[q], t = g.dataPoints;
                    if (0 < t.length) {
                        var h = 5 < p && g.bevelEnabled ? !0 : !1;
                        c.strokeStyle = "#4572A7 ";
                        for (f = 0; f < t.length; f++) if (t[f].getTime ? D = t[f].x.getTime() : D = t[f].x, !(D < a.axisX.dataInfo.viewPortMin || D > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[f].y) {
                            ...
                            s = a.axisX.reversed ? s + a.plotType.totalDataSeries * p / 2 - (a.previousDataSeriesCount + n) * p << 0 : s - a.plotType.totalDataSeries * p / 2 + (a.previousDataSeriesCount +
                                n) * p << 0;
                            var r = a.axisX.reversed ? s - p << 0 : s + p << 0, u;
                            0 <= t[f].y ? u = k : (u = l, l = k);
                            b = t[f].color ? t[f].color : g._colorSet[f % g._colorSet.length];
                            ...
                            (t[f].indexLabel ||
                                ...
                                direction: 0 > t[f].y === a.axisY.reversed ? 1 : -1,
                                bounds: {x1: Math.min(u, l), y1: s, x2: Math.max(u, l), y2: r},
                                color: b
                            })
                        }
                    }
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++) if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                            ...
                            (u[k].indexLabel || r.indexLabel || u[k].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                                ...
                                direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1,
                                bounds: {x1: Math.min(x, n), y1: p, x2: Math.max(x, n), y2: z},
                                color: b
                            })
                        }
                    }
        ...
        m.prototype.renderArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var l =
                    this._eventManager.ghostCtx, s = a.axisY.lineCoordinates, D = [], k = this.plotArea, n;
                f.save();
                w && l.save();
                f.beginPath();
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    var q = a.dataSeriesIndexes[p], g = this.data[q], t = g.dataPoints, D = g.id;
                    this._eventManager.objectMap[D] = {objectType: "dataSeries", dataSeriesIndex: q};
                    D = P(D);
                    l.fillStyle = D;
                    D = [];
                    d = !0;
                    var h = 0, r, u, m, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                        a.axisY.viewportMinimum : 0), z, G = null;
                    if (0 < t.length) {
                        ...
                        for (var ka = !0; h < t.length; h++) if (m = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ka))) if ("number" !==
                            ...
                            d || ka ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = r, c = u, r = n.x, u = n.y, b(), f.moveTo(n.x, n.y), r = d, u = c, G = n, c = g.nullDataLineDashType, f.setLineDash(M)), f.lineTo(r, u), w && l.lineTo(r, u)) : (f.beginPath(), f.moveTo(r, u), w && (l.beginPath(), l.moveTo(r, u)), G = {
                                x: r,
                                y: u
                            }), ka = d = !1) : (f.lineTo(r, u), w && l.lineTo(r,
                                u), 0 == h % 250 && b());
                            n = {x: r, y: u};
                            ...
                            0 !== t[h].markerSize && (0 < t[h].markerSize || 0 < g.markerSize) && (m = g.getMarkerProperties(h,
                                r, u, f), D.push(m), aa = P(aa), w && D.push({
                                x: r,
                                y: u,
                                ctx: l,
                                type: m.type,
        ...
        m.prototype.renderSplineArea = function (a) {
            function d() {
                ...
                if (0 < c.length) {
                    if (0 < n.lineThickness) {
                        ...
                        for (var d = 0; d < c.length - 3; d += 3) if (b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), w && e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), c[d + 3].newStrokeStyle || c[d + 3].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(c[d + 3].x, c[d + 3].y), c[d + 3].newStrokeStyle && (b.strokeStyle =
            ...
            var c = a.targetCanvasCtx || this.plotArea.ctx, b = w ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = this._eventManager.ghostCtx, f = a.axisY.lineCoordinates, l = [], s = this.plotArea;
                b.save();
                w && e.save();
                b.beginPath();
                b.rect(s.x1, s.y1, s.width, s.height);
                b.clip();
                w && (e.beginPath(), e.rect(s.x1, s.y1, s.width,
                    s.height), e.clip());
                for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                    var k = a.dataSeriesIndexes[h], n = this.data[k], p = n.dataPoints, l = n.id;
                    this._eventManager.objectMap[l] = {objectType: "dataSeries", dataSeriesIndex: k};
                    l = P(l);
                    e.fillStyle = l;
                    var l = [], q = 0, g, t,
                        r = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), m, u = null,
                        y = [];
                    if (0 < p.length) {
                        var x = n._colorSet[q % n._colorSet.length], z = n.lineColor = n.options.lineColor || x, G = z;
                        b.fillStyle = x;
                        b.strokeStyle = z;
                        b.lineWidth = n.lineThickness;
                        var C = "solid";
                        if (b.setLineDash) {
                            var A = J(n.nullDataLineDashType, n.lineThickness), C = n.lineDashType,
                                E = J(C, n.lineThickness);
                            b.setLineDash(E)
                        }
                        for (t = !1; q < p.length; q++) if (g = p[q].x.getTime ? p[q].x.getTime() : p[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !t))) if ("number" !== typeof p[q].y) 0 < q && !t && (n.connectNullData ? b.setLineDash && (0 < y.length && (n.options.nullDataLineDashType || !p[q - 1].lineDashType)) && (y[y.length - 1].newLineDashArray = A, C = n.nullDataLineDashType) : (d(), y = [])), t = !0;
                        else {
                            ...
                            y[y.length] = {x: g, y: t};
                            q < p.length - 1 && (G !== (p[q].lineColor || z) || C !== (p[q].lineDashType || n.lineDashType)) && (G = p[q].lineColor || z, y[y.length - 1].newStrokeStyle = G, b.setLineDash && (p[q].lineDashType ? (C = p[q].lineDashType, y[y.length - 1].newLineDashArray = J(C, n.lineThickness)) : (C = n.lineDashType, y[y.length - 1].newLineDashArray =
                                E)));
        ...
        m.prototype.renderStepArea = function (a) {
            ...
            var e = a.targetCanvasCtx ||
                this.plotArea.ctx, f = w ? this._preRenderCtx : e;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var l = this._eventManager.ghostCtx, s = a.axisY.lineCoordinates, h = [], k = this.plotArea, n;
                f.save();
                w && l.save();
                f.beginPath();
                f.rect(k.x1, k.y1, k.width, k.height);
                ...
                w && (l.beginPath(), l.rect(k.x1, k.y1, k.width, k.height), l.clip());
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    var q = a.dataSeriesIndexes[p], g = this.data[q], t = g.dataPoints, h = g.id;
                    ...
                    d = !0;
                    var r = 0, m, u, y,
                        x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), z, G = null;
                    c = !1;
                    if (0 < t.length) {
                        ...
                        var M = "solid";
                        if (f.setLineDash) {
                            var T = J(g.nullDataLineDashType, g.lineThickness), M = g.lineDashType,
                                B = J(M, g.lineThickness);
                            f.setLineDash(B)
                        }
                        for (; r < t.length; r++) if (y = t[r].x.getTime ? t[r].x.getTime() : t[r].x, !(y < a.axisX.dataInfo.viewPortMin ||
                            ...
                            "number" !== typeof t[r].y ? (g.connectNullData || (c || d) || b(), c = !0) : (m = a.axisX.convertValueToPixel(y), u = a.axisY.convertValueToPixel(t[r].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || M === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = u, m = n.x, u = n.y, b(), f.moveTo(n.x, n.y), m = d, u = c, G = n, M = g.nullDataLineDashType, f.setLineDash(T)), f.lineTo(m, aa), f.lineTo(m, u), w && (l.lineTo(m, aa), l.lineTo(m, u))) :
                                (f.beginPath(), f.moveTo(m, u), w && (l.beginPath(), l.moveTo(m, u)), G = {
                                    x: m,
                                    y: u
        ...
        m.prototype.renderStackedArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, l = [], s = this.plotArea, h = [],
                    ...
                    m = this._eventManager.ghostCtx, u, y, x;
                w && m.beginPath();
                b.save();
                w && m.save();
                b.beginPath();
                ...
                for (var e = [], z = 0; z < a.dataSeriesIndexes.length; z++) {
                    ...
                    C.dataPointIndexes = [];
                    for (q = 0; q < v.length; q++) G = v[q].x.getTime ? v[q].x.getTime() : v[q].x, C.dataPointIndexes[G] =
                        q, e[G] || (n.push(G), e[G] = !0);
                    n.sort(Qa)
                }
                    ...
                    if (0 < n.length) {
                        ...
                        for (var aa = !0, q = 0; q < n.length; q++) {
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !aa))) if ("number" !== typeof ga.y) C.connectNullData || (aa || y) || d(), aa = !0; else {
                                ...
                                k.push({x: g, y: r - na});
                                h[f] = r - t;
                                y || aa ? (!y && C.connectNullData ? (b.setLineDash && (C.options.nullDataLineDashType || x === C.lineDashType && C.lineDashType !== C.nullDataLineDashType) && (y = k.pop(), x = k[k.length - 1], d(), b.moveTo(u.x, u.y), k.push(x), k.push(y), x = C.nullDataLineDashType, b.setLineDash(T)), b.lineTo(g, t), w && m.lineTo(g, t)) : (b.beginPath(), b.moveTo(g, t), w && (m.beginPath(), m.moveTo(g, t))), aa = y = !1) : (b.lineTo(g, t), w && m.lineTo(g, t),
                                0 == q % 250 && (d(), b.moveTo(g, t), w && m.moveTo(g, t), k.push({x: g, y: r - na})));
                                u = {x: g, y: t};
        ...
        m.prototype.renderStackedArea100 = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, l = this.plotArea, s = [], h = [], k = [], n = [], p = [], q = 0, g, t, r, m, u,
                ...
                for (var e = [], z = 0; z < a.dataSeriesIndexes.length; z++) {
                    ...
                    C.dataPointIndexes =
                        [];
                    for (q = 0; q < v.length; q++) G = v[q].x.getTime ? v[q].x.getTime() : v[q].x, C.dataPointIndexes[G] = q, e[G] || (n.push(G), e[G] = !0);
                    n.sort(Qa)
                }
                for (z = 0; z < a.dataSeriesIndexes.length; z++) {
                    G = a.dataSeriesIndexes[z];
                    ...
                    k = [];
                    if (0 < n.length) {
                        var e = C._colorSet[q % C._colorSet.length], A = C.lineColor = C.options.lineColor || e, M = A;
                        b.fillStyle = e;
                        b.strokeStyle = A;
                        b.lineWidth = C.lineThickness;
                        u = "solid";
                        ...
                        for (var aa = !0, q = 0; q < n.length; q++) {
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !aa))) if ("number" !== typeof ga.y) C.connectNullData || (aa || m) || d(), aa = !0; else {
                                ...
                                k.push({x: g, y: y - E});
                                h[f] = y - t;
                                m || aa ? (!m && C.connectNullData ? (b.setLineDash && (C.options.nullDataLineDashType || u === C.lineDashType && C.lineDashType !== C.nullDataLineDashType) && (m = k.pop(), u = k[k.length - 1], d(), b.moveTo(r.x, r.y), k.push(u), k.push(m), u = C.nullDataLineDashType,
                                    b.setLineDash(T)), b.lineTo(g, t), w && x.lineTo(g, t)) : (b.beginPath(), b.moveTo(g, t), w && (x.beginPath(), x.moveTo(g, t))), aa = m = !1) : (b.lineTo(g, t), w && x.lineTo(g, t), 0 == q % 250 && (d(), b.moveTo(g, t), w && x.moveTo(g, t), k.push({
                                    x: g,
                                    y: y - E
                                })));
                                r = {x: g, y: t};
                                q < v.length - 1 && (M !== (v[q].lineColor || A) || u !== (v[q].lineDashType || C.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, t), k.push({
                                    x: g,
                                    y: y - E
                                }), M = v[q].lineColor || A, b.strokeStyle = M, b.setLineDash && (v[q].lineDashType ? (u = v[q].lineDashType, b.setLineDash(J(u, C.lineThickness))) : (u = C.lineDashType,
                                    b.setLineDash(B))));
                                if (0 <= C.dataPointIndexes[f]) {
                                ...
                                (ga.indexLabel || C.indexLabel || ga.indexLabelFormatter ||
                ...
                ba.drawMarkers(s);
                w && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width,
                    this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(l.x1, l.y1, l.width, l.height), x.restore());
                b.restore();
                return {
                    source: c,
                    dest: this.plotArea.ctx,
        ...
        m.prototype.renderBubble = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var s = -Infinity, h = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++) for (var n = a.dataSeriesIndexes[k], p = this.data[n], q = p.dataPoints, g = 0, e = 0; e < q.length; e++) f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof q[e].z || (g = q[e].z, g >
                s && (s = g), g < h && (h = g));
                for (var t = 25 * Math.PI, r = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, t), k = 0; k < a.dataSeriesIndexes.length; k++) if (n = a.dataSeriesIndexes[k], p = this.data[n], q = p.dataPoints, 0 < q.length) for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++) if (f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[e].y) {
                    ...
                    var g = q[e].z, m = 2 * Math.max(Math.sqrt((s ===
                    h ? r / 2 : t + (r - t) / (s - h) * (g - h)) / Math.PI) << 0, 1), g = p.getMarkerProperties(e, c);
                    g.size = m;
                ...
                w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
                    0, 0, this.width, this.height), c.clearRect(b.x1, b.y1, b.width, b.height), this._eventManager.ghostCtx.restore());
                c.restore();
                return {
                    source: d,
                    dest: this.plotArea.ctx,
        ...
        m.prototype.renderScatter = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                w && this._eventManager.ghostCtx.save();
                c.beginPath();
                c.rect(b.x1, b.y1, b.width,
                    b.height);
                c.clip();
                w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(b.x1, b.y1, b.width, b.height), this._eventManager.ghostCtx.clip());
                for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
                    var h = a.dataSeriesIndexes[s], k = this.data[h], n = k.dataPoints;
                    if (0 < n.length) {
                        c.strokeStyle = "#4572A7 ";
                        Math.pow(0.3 * Math.min(b.height, b.width) / 2, 2);
                        for (var p = 0, q = 0, e = 0; e < n.length; e++) if (f = n[e].getTime ? f = n[e].x.getTime() : f = n[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" ===
                        typeof n[e].y) {
                            f = a.axisX.convertValueToPixel(f);
                            ...
                            w && ba.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, p, p, g.borderThickness), (n[e].indexLabel || k.indexLabel || n[e].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "scatter",
                                dataPoint: n[e],
                                dataSeries: k,
                                point: {x: f, y: l},
        ...
        m.prototype.renderCandlestick = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx,
                c = w ? this._preRenderCtx : d, b = this._eventManager.ghostCtx;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, l = this.plotArea, s = 0, h, k, n, p, q, g,
                    ...
                    t = a.axisX.dataInfo.minDiff;
                isFinite(t) || (t = 0.3 * Math.abs(a.axisX.range));
                t = this.options.dataPointWidth ? this.dataPointWidth : 0.7 * l.width *
                    (a.axisX.logarithmic ? Math.log(t) / Math.log(a.axisX.range) : Math.abs(t) / Math.abs(a.axisX.range)) << 0;
                ...
                for (var m =
                    ...
                    var fa = a.dataSeriesIndexes[m], u = this.data[fa], y = u.dataPoints;
                    if (0 < y.length) for (var x = 5 < t && u.bevelEnabled ? !0 : !1, s = 0; s < y.length; s++) if (y[s].getTime ? g = y[s].x.getTime() : g = y[s].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(y[s].y) && y[s].y.length && "number" === typeof y[s].y[0] && "number" === typeof y[s].y[1] && "number" === typeof y[s].y[2] && "number" === typeof y[s].y[3]) {
                        ...
                        var z = h - t / 2 << 0, G = z + t << 0,
                            f = u.options.fallingColor ? u.fallingColor : u._colorSet[0],
                            e = y[s].color ? y[s].color : u._colorSet[0], C = Math.round(Math.max(1, 0.15 * t)),
                            v = 0 === C % 2 ? 0 : 0.5, A = u.dataPointIds[s];
                        ...
                        "candlestick" === u.type ? (c.moveTo(h - v, n), c.lineTo(h - v, Math.min(k, q)), c.stroke(), c.moveTo(h - v, Math.max(k, q)), c.lineTo(h - v, p), c.stroke(), ea(c, z, Math.min(k, q), G, Math.max(k, q), y[s].y[0] <= y[s].y[3] ? u.risingColor : f, C, e, x, x, !1, !1, u.fillOpacity), w && (e = P(A), b.strokeStyle = e, b.moveTo(h - v, n), b.lineTo(h - v, Math.min(k, q)), b.stroke(), b.moveTo(h - v, Math.max(k, q)), b.lineTo(h - v, p), b.stroke(), ea(b, z, Math.min(k, q), G, Math.max(k, q), e, 0, null, !1, !1, !1, !1))) : "ohlc" === u.type && (c.moveTo(h - v, n), c.lineTo(h - v, p), c.stroke(), c.beginPath(),
                            c.moveTo(h, k), c.lineTo(z, k), c.stroke(), c.beginPath(), c.moveTo(h, q), c.lineTo(G, q), c.stroke(), w && (e = P(A), b.strokeStyle = e, b.moveTo(h - v, n), b.lineTo(h - v, p), b.stroke(), b.beginPath(), b.moveTo(h, k), b.lineTo(z, k), b.stroke(), b.beginPath(), b.moveTo(h, q), b.lineTo(G, q), b.stroke()));
                        (y[s].indexLabel || u.indexLabel || y[s].indexLabelFormatter || u.indexLabelFormatter) && this._indexLabels.push({
                            chartType: u.type,
                            dataPoint: y[s],
                            dataSeries: u,
                            point: {x: z + (G - z) / 2, y: a.axisY.reversed ? p : n},
                            direction: 1,
                            bounds: {
                                x1: z, y1: Math.min(n,
        ...
        m.prototype.renderBoxAndWhisker = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = this.plotArea, l = 0, s, h, k, n, p, q, g,
                    e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
                    l = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ?
                        this.dataPointWidth : 0.015 * this.width, t = a.axisX.dataInfo.minDiff;
                isFinite(t) || (t = 0.3 * Math.abs(a.axisX.range));
                ...
                for (var m = !1, m = !!a.axisY.reversed, fa = 0; fa < a.dataSeriesIndexes.length; fa++) {
                    var u = a.dataSeriesIndexes[fa], y = this.data[u], x = y.dataPoints;
                    if (0 < x.length) for (var z = 5 < t && y.bevelEnabled ? !0 : !1, l = 0; l < x.length; l++) if (x[l].getTime ? g = x[l].x.getTime() : g = x[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(x[l].y) && x[l].y.length &&
                    "number" === typeof x[l].y[0] && "number" === typeof x[l].y[1] && "number" === typeof x[l].y[2] && "number" === typeof x[l].y[3] && "number" === typeof x[l].y[4] && 5 === x[l].y.length) {
                        ...
                        var G = s - t / 2 << 0, C = s + t / 2 << 0, e = x[l].color ? x[l].color : y._colorSet[0],
                            v = Math.round(Math.max(1, 0.15 * t)), A =
                                0 === v % 2 ? 0 : 0.5,
                            ...
                            aa = "number" === typeof aa ? 0 >= aa ? 0 : aa >= t ? t : aa : "string" === typeof aa ? parseInt(aa) * t / 100 > t ?
                                t : parseInt(aa) * t / 100 : t, ga = 1 === Math.round(T) % 2 ? 0.5 : 0,
                            ...
                            O = "number" === typeof x[l].lineThickness ? x[l].lineThickness :
                                "number" === typeof y.options.lineThickness ? y.lineThickness : v,
                            R = x[l].lineDashType ? x[l].lineDashType : y.lineDashType,
                            L = 1 === Math.round(O) % 2 ? 0.5 : 0, S = y.upperBoxColor, U = y.lowerBoxColor,
                            ra = r(y.options.fillOpacity) ? 1 : y.fillOpacity, Q = y.dataPointIds[l];
                        ...
                        c.beginPath();
                        ea(c, G, Math.min(q, k), C, Math.max(k, q), U, 0, e, m ? z : !1, m ? !1 : z, !1, !1, ra);
                        c.beginPath();
                        ea(c, G, Math.min(n, q), C, Math.max(q, n), S, 0, e, m ? !1 : z, m ? z : !1, !1, !1, ra);
                        c.beginPath();
                        c.lineWidth = v;
                        c.strokeStyle = e;
                        c.rect(G - A, Math.min(k, n) - A, C - G + 2 * A, Math.max(k, n) - Math.min(k,
                            n) + 2 * A);
                        c.stroke();
                        c.save();
                        ...
                        c.restore();
                        w && (e = P(Q), b.strokeStyle = e, b.lineWidth = E, 0 < E && (b.moveTo(s - A - F, k), b.lineTo(s - A - F, Math.max(h,
                            p)), b.stroke(), b.moveTo(s - A - F, Math.min(h, p)), b.lineTo(s - A - F, n), b.stroke()), ea(b, G, Math.max(k, n), C, Math.min(k, n), e, 0, null, !1, !1, !1, !1), 0 < T && (b.beginPath(), b.lineWidth = T, b.moveTo(s + aa / 2, p - ga), b.lineTo(s - aa / 2, p - ga), b.stroke(), b.moveTo(s + aa / 2, h + ga), b.lineTo(s - aa / 2, h + ga), b.stroke()));
                        (x[l].indexLabel || y.indexLabel || x[l].indexLabelFormatter || y.indexLabelFormatter) && this._indexLabels.push({
                            chartType: y.type,
                            dataPoint: x[l],
                            dataSeries: y,
                            point: {x: G + (C - G) / 2, y: a.axisY.reversed ? h : p},
                            direction: 1,
                            bounds: {
                                x1: G, y1: Math.min(h,
        ...
        m.prototype.renderRangeColumn = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, l, s, h,
                    f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < g.length) for (var t = 5 < k && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++) if (g[f].getTime ? h = g[f].x.getTime() : h = g[f].x, !(h < a.axisX.dataInfo.viewPortMin ||
                        ...
                        if (g[f].indexLabel || q.indexLabel || g[f].indexLabelFormatter || q.indexLabelFormatter) this._indexLabels.push({
                            ...
                            dataSeries: q,
                            indexKeyword: 0,
                            point: {x: m + (fa - m) / 2, y: g[f].y[1] >= g[f].y[0] ? s : l},
                            direction: g[f].y[1] >= g[f].y[0] ? -1 : 1,
                            bounds: {x1: m, y1: Math.min(l, s), x2: fa, y2: Math.max(l, s)},
                            color: b
                        }), this._indexLabels.push({
                            chartType: "rangeColumn",
                            dataPoint: g[f],
                            dataSeries: q,
                            indexKeyword: 1,
                            point: {x: m + (fa - m) / 2, y: g[f].y[1] >= g[f].y[0] ? l : s},
                            direction: g[f].y[1] >= g[f].y[0] ? 1 : -1,
                            bounds: {x1: m, y1: Math.min(l, s), x2: fa, y2: Math.max(l, s)},
                            color: b
                        })
        ...
        m.prototype.renderError = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = !1, l = this.plotArea, s = 0, h, k, n, p, q, g, t, m = a.axisX.dataInfo.minDiff;
                ...
                c.rect(l.x1, l.y1, l.width, l.height);
                c.clip();
                w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(l.x1, l.y1, l.width,
                ...
                for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
                    var x = a.dataSeriesIndexes[y], z = this.data[x], v = z.dataPoints,
                        C = r(z._linkedSeries) ? !1 : z._linkedSeries.type.match(/(bar|column)/ig) && z._linkedSeries.visible ? !0 : !1,
                        A = 0;
                    if (C) for (e = z._linkedSeries.id, u = 0; u < e; u++) !this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible ||
                    this.data[u].type.match(/(stacked)/ig) && A || (this.data[u].type.match(/(range)/ig) && (f = !0), A++);
                    e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                    ...
                    f && (s = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 *
                        this.height, 0.9 * (this.plotArea.height / (C ? fa : 1))) << 0 : 0.03 * this.width);
                    ...
                    if (0 < v.length) for (var B = z._colorSet, s = 0; s < v.length; s++) {
                        ...
                        var T = {
                            ...
                            dashType: v[s].stemDashType ? v[s].stemDashType :
                                z.stemDashType
                        };
                        ...
                        if (!(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax) && !r(v[s].y) && v[s].y.length && "number" === typeof v[s].y[0] && "number" === typeof v[s].y[1]) {
                            ...
                            b ? p = ka : g = ka;
                            b ? (q = a.axisX.reversed ? k + (C ? fa : 1) * u / 2 - (C ? A - 1 : 0) *
                                u << 0 : k - (C ? fa : 1) * u / 2 + (C ? A - 1 : 0) * u << 0, g = a.axisX.reversed ? q - u << 0 : q + u << 0) : (n = a.axisX.reversed ? h + (C ? fa : 1) * u / 2 - (C ? A - 1 : 0) * u << 0 : h - (C ? fa : 1) * u / 2 + (C ? A - 1 : 0) * u << 0, p = a.axisX.reversed ? n - u << 0 : n + u << 0);
                            !b && q > g && (ka = q, q = g, g = ka);
                            b && n > p && (ka = n, n = p, p = ka);
                            ka = z.dataPointIds[s];
                            ...
                            E(c, Math.min(n, p), Math.min(q, g),
                                Math.max(p, n), Math.max(g, q), e, M, T, b);
        ...
        m.prototype.renderRangeBar = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b =
                        null, e = this.plotArea, f = 0, l, s, h, k,
                    f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1,
                    e.y1, e.width, e.height), this._eventManager.ghostCtx.clip());
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    var q = a.dataSeriesIndexes[p], g = this.data[q], t = g.dataPoints;
                    if (0 < t.length) {
                        var m = 5 < n && g.bevelEnabled ? !0 : !1;
                        c.strokeStyle = "#4572A7 ";
                        for (f = 0; f < t.length; f++) if (t[f].getTime ? k = t[f].x.getTime() : k = t[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !r(t[f].y) && t[f].y.length && "number" === typeof t[f].y[0] && "number" === typeof t[f].y[1]) {
        ...
        m.prototype.renderRangeArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
                    var h = [], k = a.dataSeriesIndexes[s], n = this.data[k], p = n.dataPoints, f = n.id;
                    this._eventManager.objectMap[f] = {objectType: "dataSeries", dataSeriesIndex: k};
                    f = P(f);
                    e.fillStyle = f;
                    var f = [], q = !0, g = 0, t, r, m, u, y = null;
                    if (0 < p.length) {
                        var x = n._colorSet[g % n._colorSet.length], z = n.lineColor = n.options.lineColor || x, v = z;
                        b.fillStyle = x;
                        b.strokeStyle = z;
                        b.lineWidth = n.lineThickness;
                        var C = "solid";
                        if (b.setLineDash) {
                            var A = J(n.nullDataLineDashType,
                                n.lineThickness), C = n.lineDashType, B = J(C, n.lineThickness);
                            b.setLineDash(B)
                        }
                        for (var M = !0; g < p.length; g++) if (u = p[g].x.getTime ? p[g].x.getTime() : p[g].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !M))) if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                            ...
                            q || M ? (n.connectNullData && !q ? (b.setLineDash && (n.options.nullDataLineDashType ||
                                C === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (h[h.length - 1].newLineDashArray = B, C = n.nullDataLineDashType, b.setLineDash(A)), b.lineTo(t, r), w && e.lineTo(t, r), h.push({
                                x: t,
                                y1: r,
                                y2: m
                            })) : (b.beginPath(), b.moveTo(t, r), y = {x: t, y: r}, h = [], h.push({
                                x: t,
                                y1: r,
                                y2: m
                            ...
                            if (p[g].indexLabel || n.indexLabel || p[g].indexLabelFormatter || n.indexLabelFormatter) this._indexLabels.push({
                                ...
                                indexKeyword: 0,
                                point: {x: t, y: r},
                                direction: p[g].y[0] > p[g].y[1] === a.axisY.reversed ? -1 :
                                    1,
                                color: x
                            }), this._indexLabels.push({
                                chartType: "rangeArea",
        ...
        m.prototype.renderRangeSplineArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
                    var h =
                        a.dataSeriesIndexes[s], k = this.data[h], n = k.dataPoints, f = k.id;
                    ...
                    if (0 < n.length) {
                        ...
                        for (g = !1; p < n.length; p++) if (q = n[p].x.getTime ? n[p].x.getTime() :
                            ...
                            m[m.length] = {x: q, y: t};
                            p < n.length - 1 && (x !==
                                (n[p].lineColor || y) || z !== (n[p].lineDashType || k.lineDashType)) && (x = n[p].lineColor || y, r[r.length - 1].newStrokeStyle = x, b.setLineDash && (n[p].lineDashType ? (z = n[p].lineDashType, r[r.length - 1].newLineDashArray = J(z, k.lineThickness)) : (z = k.lineDashType, r[r.length - 1].newLineDashArray = A)));
        ...
        m.prototype.renderWaterfall = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = this._eventManager.ghostCtx,
                    e = null, f = this.plotArea, l = 0, s, h, k, n,
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    var t = a.dataSeriesIndexes[g], r = this.data[t], m = r.dataPoints, e = r._colorSet[0];
                    ...
                    var u = "number" === typeof r.options.lineThickness ? Math.round(r.lineThickness) : 1,
                        y = 1 === Math.round(u) %
                        2 ? -0.5 : 0;
                    if (0 < m.length) for (var x = 5 < q && r.bevelEnabled ? !0 : !1, v = !1, A = null, C = null, l = 0; l < m.length; l++) if (m[l].getTime ? n = m[l].x.getTime() : n = m[l].x, "number" !== typeof m[l].y) {
                        ...
                        ea(c, a.axisX.reversed ? B : s, a.axisY.reversed ? k : h, a.axisX.reversed ?
                            s : B, a.axisY.reversed ? h : k, M, 0, M, x, x, !1, !1, r.fillOpacity);
                        e = P(e);
                        ...
                        0 < l && A && (!v || r.connectNullData) && (v && c.setLineDash && c.setLineDash(J(E, u)), c.beginPath(), c.moveTo(A, C - y), c.lineTo(M, T - y), 0 < u && c.stroke(), w && (b.beginPath(), b.moveTo(A,
                            C - y), b.lineTo(M, T - y), 0 < u && b.stroke()));
                        v = !1;
                        A = B;
                        C = 0 < m[l].y ? h : k;
                        ...
                        (m[l].indexLabel || r.indexLabel || m[l].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                            ...
                            dataPoint: m[l],
                            dataSeries: r,
                            point: {x: s + (B - s) / 2, y: 0 <= m[l].y ? h : k},
                            direction: 0 > m[l].y === a.axisY.reversed ? 1 : -1,
                            bounds: {x1: s, y1: Math.min(h, k), x2: B, y2: Math.max(h, k)},
                            color: e
                        })
                    }
                }
        ...
        m.prototype.renderPie = function (a) {
            function d() {
                if (k && n) {
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < n.length; e++) {
                        ...
                        var h = g[e], p = {percent: null, total: null}, s = null, p = m.getPercentAndTotal(k,
                            f);
            ...
            function c(a) {
                ...
                for (b = 0; b < n.length; b++) {
                    ...
                    if (d > c) {
                        var e = 0.07 * C * Math.cos(g[b].midAngle), f = 0.07 * C * Math.sin(g[b].midAngle), l = !1;
                        if (n[b].exploded) {
            ...
            function b(a, b) {
                var c = 0, c = a.indexLabelTextBlock.y - a.indexLabelTextBlock.height /
                        2, d = a.indexLabelTextBlock.y + a.indexLabelTextBlock.height / 2,
            ...
            function e(a) {
                for (var c = null, d = 1; d < n.length; d++) if (c = (a + d + g.length) % g.length, g[c].hemisphere !== g[a].hemisphere) {
                    ...
                    g[a].indexLabelTextBlock.y))) break; else c = null;
                return c
            }
            ...
            function l() {
                ...
                for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                    ...
                    } else for (a = 0; a < n.length; a++) h = g[a], w = "pie" === k.type ? 0.7 * C : 0.8 * C, u = x.x + w * Math.cos(h.midAngle), r = x.y + w * Math.sin(h.midAngle), h.indexLabelTextBlock.x = u, h.indexLabelTextBlock.y = r;
                    for (a = 0; a < n.length; a++) if (h = g[a], u = h.indexLabelTextBlock.measureText(),
                    0 !== u.height && 0 !== u.width) u = u = 0, "right" === h.hemisphere ? (u = q.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width + p), u *= -1) : u = q.x1 - (h.indexLabelTextBlock.x - h.indexLabelTextBlock.width - p), 0 < u && (!l && h.indexLabelText && (r = "right" === h.hemisphere ? q.x2 - h.indexLabelTextBlock.x : h.indexLabelTextBlock.x - q.x1, 0.3 * h.indexLabelTextBlock.maxWidth > r ? h.indexLabelText = "" : h.indexLabelTextBlock.maxWidth = 0.85 * r, 0.3 * h.indexLabelTextBlock.maxWidth < r && (h.indexLabelTextBlock.x -= "right" === h.hemisphere ? 2 : -2)), Math.abs(h.indexLabelTextBlock.y -
                        ...
                        x.x) < C && (u /= Math.abs(Math.sin(h.indexLabelAngle)), 9 < u && (u *= 0.3), u > d && (d = u)));
                    ...
                    (function () {
                        for (var a = -1, c = -1, d = 0, f = !1, k = 0; k < n.length; k++) if (f = !1, s = g[k], s.indexLabelText) {
                            ...
                            if (null !== l) {
                                ...
                                q ? (0 > a && (a = k), l !== a && (c = l, d += -z), 0 === k % Math.max(n.length /
                                    10, 3) && (f = !0)) : f = !0;
            ...
            var m = this;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var k = this.data[a.dataSeriesIndexes[0]], n = k.dataPoints, p = 10, q = this.plotArea,
                    g = k.dataPointEOs, t = 2, w, v = 1.3, u = 20 / 180 * Math.PI, y = 6,
                    x = {x: (q.x2 + q.x1) / 2, y: (q.y2 + q.y1) / 2}, z = 0;
                a = !1;
                for (var A = 0; A < n.length; A++) z += Math.abs(n[A].y), !a && ("undefined" !== typeof n[A].indexLabel && null !== n[A].indexLabel && 0 < n[A].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof n[A].label && null !== n[A].label &&
                    0 < n[A].label.toString().length) && (a = !0);
                if (0 !== z) {
                    ...
                    this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function (a) {
                        ...
                        m._animator.animate(0,
                            m.animatedRender ? 500 : 0, function (a) {
                                c(a);
                                h();
                                m.dispatchEvent("dataAnimationIterationEnd", {chart: m})
                            });
        ...
        m.prototype.renderFunnel = function (a) {
            ...
            function c() {
                ...
                if (0 === g) return -1;
                for (var l = d[0] = 0, h = 0, n, p, b = b - a, l = !1, k = 0; k < y.length; k++) a = Math.abs(y[k].y) * f / g, l ? n = 0 == Number(c.toFixed(3)) ? 0 : a / c : (p = $ * $ * b * b - 4 * Math.abs($) * a, 0 > p ? (p = c, l = (b + p) * (e - h) / 2, a -= l, n = e - h, h += e - h, n += 0 == p ? 0 : a / p, h += a / p, l = !0) : (n = (Math.abs($) * b - Math.sqrt(p)) / 2, p = b - 2 * n / Math.abs($), h += n, h > e && (h -= n, p = c, l = (b + p) * (e - h) / 2, a -= l, n = e - h, h += e - h, n += a / p, h += a / p, l = !0), b =
                    p)), d.push(n);
                return d
            }
            ...
            function b() {
                if (u && y) {
                    for (var a, b, c, d, e, f, k, l, h, n, p, q, s, m, t, D = [], x = [], v = {
                        percent: null,
                        total: null
                    }, z = null, C = 0; C < y.length; C++) t = Q[C], t = "undefined" !== typeof t.x5 ? (t.y2 + t.y4) / 2 : (t.y2 + t.y3) / 2, t = g(t).x2 + 1, D[C] = K - t - W;
                    t = 0.5 * W;
                    for (var C = 0, B = y.length - 1; C < y.length || 0 <= B; C++, B--) {
                        ...
                        "inside" === u.indexLabelPlacement && (D[C] = C !== ca ? u.reversed ? Q[C].x2 - Q[C].x1 :
                            Q[C].x3 - Q[C].x4 : Q[C].x3 - Q[C].x6, 20 > D[C] && (D[C] = C !== ca ? u.reversed ? Q[C].x3 - Q[C].x4 : Q[C].x2 - Q[C].x1 : Q[C].x2 - Q[C].x1, D[C] /= 2));
                        ...
                        b = b.indexLabelFormatter ? b.indexLabelFormatter(z) : b.indexLabel ?
                            A.replaceKeywordsWithValue(b.indexLabel, b, u, C) : u.indexLabelFormatter ? u.indexLabelFormatter(z) : u.indexLabel ? A.replaceKeywordsWithValue(u.indexLabel, b, u, C) : b.label ? b.label : "";
                        0 >= n && (n = 0);
            ...
            function e() {
                ...
                if (e) for (l = H.length - 1; 0 <= l; l--) a = Q[l], H[l].textBlock.maxWidth =
            ...
            function l() {
                ...
                for (var d, e, f, g, l, k, n = 1, r = 0; r < 2 * n; r++) {
                    for (var m = H.length - 1; 0 <= m && !(0 <= p(m) && p(m), f = H[m], g = f.textBlock,
                        k = (l = q(m) < Q.length ? H[q(m)] : null) ? l.textBlock : null, d = +f.height.toFixed(6), e = +g.y.toFixed(6), !f.isDirty && (l && e + d + da > +k.y.toFixed(6)) && (d = g.y + d + da - k.y, e = a(m, -d), e < d && (0 < e && (d -= e), e = a(q(m), d), e != d))); m--) ;
                    b()
                }
            }

            function h(a, b) {
                return (b < Q.length ? H[b].textBlock.y : u.reversed ? oa + z : ra + z) - (0 > a ? u.reversed ? ra - z : oa - z : H[a].textBlock.y + H[a].height + da)
            }
            ...
            function g(a) {
                for (var b, c = 0; c < y.length; c++) if (Q[c].y1 < a && Q[c].y4 > a) {
                    b = Q[c];
                    break
                }
            ...
            function t(a) {
                for (var b = 0; b < Q.length; b++) H[b].isDirty || (a && (H[b].textBlock.ctx = a), H[b].textBlock.render(!0))
            }
            ...
            function v(a) {
                ...
                if (A.subtitles) for (var b = 0; b < A.subtitles.length; b++) {
                    var c = A.subtitles[b];
                    if (c.dockInsidePlotArea || "center" === c.horizontalAlign && "center" === c.verticalAlign) A.subtitles.ctx =
                        a, c.render()
                }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (var u = this.data[a.dataSeriesIndexes[0]], y = u.dataPoints, x = this.plotArea, z = 0.025 * x.width, B = 0.01 * x.width, C = 0, E = x.height - 2 * z, I = Math.min(x.width - 2 * B, 2.8 * x.height), M = !1, T = 0; T < y.length; T++) if (!M && ("undefined" !== typeof y[T].indexLabel && null !== y[T].indexLabel &&
                    0 < y[T].indexLabel.toString().length) && (M = !0), !M && ("undefined" !== typeof y[T].label && null !== y[T].label && 0 < y[T].label.toString().length) && (M = !0), !M && "function" === typeof u.indexLabelFormatter || "function" === typeof y[T].indexLabelFormatter) M = !0;
                ...
                var T = x.x1 + B, K = x.x2 - B, O = x.y1 + z, R = x.y2 - z,
                ...
                if (0 != u.length && (u.dataPoints &&
                    ...
                    var B = T + a / 2, Z = T, X = T + a, oa = u.reversed ? R : O, L = B - F / 2, ba = B + F / 2,
                        Ba = u.reversed ? O + P : R -
                            P, ra = u.reversed ? O : R;
                    a = [];
                    var B = [], Q = [], I = [], V = O, ca, $ = (Ba - oa) / (L - Z), ea = -$,
                        T = "area" === (u.valueRepresents ? u.valueRepresents : "height") ? c() : d();
                    if (-1 !== T) {
                        if (u.reversed) for (I.push(V), F = T.length - 1; 0 < F; F--) V += T[F], I.push(V); else for (F = 0; F < T.length; F++) V += T[F], I.push(V);
                        if (u.reversed) for (F = 0; F < T.length; F++) I[F] < Ba ? (a.push(L), B.push(ba), ca = F) : (a.push((I[F] - oa + $ * Z) / $), B.push((I[F] - oa + ea * X) / ea)); else for (F = 0; F < T.length; F++) I[F] < Ba ? (a.push((I[F] - oa + $ * Z) / $), B.push((I[F] - oa + ea * X) / ea), ca = F) : (a.push(L), B.push(ba));
                        for (F = 0; F < T.length - 1; F++) V = u.reversed ? y[y.length - 1 - F].color ? y[y.length - 1 - F].color : u._colorSet[(y.length - 1 - F) % u._colorSet.length] : y[F].color ? y[F].color : u._colorSet[F % u._colorSet.length], F === ca ? Q.push({
                            x1: a[F],
                            y1: I[F],
                            x2: B[F],
                            y2: I[F],
                        ...
                        var da = 2, H = [], ha = !1, Y = [], ia = [], T = !1;
                        a = a = 0;
                        Da(Y);
                        for (F = 0; F <
                        y.length; F++) y[F].exploded && (T = !0, u.reversed ? Y.push(y.length - 1 - F) : Y.push(F));
                        ...
                        if (M && u.visible && (b(), f(), e(), "inside" !== u.indexLabelPlacement)) {
                            ...
                            for (F = 0; F < Q.length; F++) Q[F].x1 += C, Q[F].x2 += C, Q[F].x3 += C, Q[F].x4 += C, Q[F].x5 && (Q[F].x5 += C, Q[F].x6 += C), H[F].textBlock.x += C
                        }
                        for (F = 0; F < Q.length; F++) C =
                            Q[F], qa(S, C, u.fillOpacity), ia.push(C.y1);
                        v(S);
                        M && u.visible && ("inside" === u.indexLabelPlacement || A.animationEnabled || n(S), A.animationEnabled || t());
                        if (!M) for (F = 0; F < y.length; F++) C = u.dataPointIds[F], a = {
                            id: C,
                            objectType: "dataPoint",
                            dataPointIndex: F,
                            dataSeriesIndex: 0,
                        ...
                        this.funnelPyramidClickHandler = function (a) {
                            var b = -1;
                            if (!ha && !A.isAnimating && (r(a.dataSeries.explodeOnClick) ||
                                a.dataSeries.explodeOnClick) && (b = u.reversed ? y.length - 1 - a.dataPointIndex : a.dataPointIndex, 0 <= b)) {
                                a = b;
                        ...
                        return {
                            source: S, dest: this.plotArea.ctx, animationCallback: function (a, b) {
            ...
            if (b && d && c) {
                ...
                if ("undefined" !== typeof Blob && new Blob) {
                    for (var l = b.replace(/^data:[a-z\/]*;base64,/, ""), l = atob(l), h = new ArrayBuffer(l.length),
                             h = new Uint8Array(h), r = 0; r < l.length; r++) h[r] = l.charCodeAt(r);
        ...
        m.prototype.getPercentAndTotal = function (a, d) {
            ...
            if (0 <= a.type.indexOf("stacked")) b = 0, c = d.x.getTime ? d.x.getTime() : d.x, c in a.plotUnit.yTotals && (b = a.plotUnit.yTotals[c], c = a.plotUnit.yAbsTotals[c],
                e = isNaN(d.y) ? 0 : 0 === c ? 0 : 100 * (d.y / c)); else if ("pie" === a.type || "doughnut" === a.type || "funnel" === a.type || "pyramid" === a.type) {
        ...
        m.prototype.replaceKeywordsWithValue = function (a, d, c, b, e) {
            ...
            if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type || "funnel" === c.type || "pyramid" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
                var l =
                        "#percent", h = "#total", r = this.getPercentAndTotal(c, d), h = isNaN(r.total) ? h : r.total,
                    l = isNaN(r.percent) ? l : r.percent;
                do {
                    r = "";
                    if (c.percentFormatString) r = c.percentFormatString; else {
                        var r = "#,##0.", k = Math.max(Math.ceil(Math.log(1 / Math.abs(l)) / Math.LN10), 2);
        ...
        R.prototype.setLayout = function () {
            var a =
                    this.dockInsidePlotArea ? this.chart.plotArea : this.chart, d = a.layoutManager.getFreeSpace(),
            ...
            if ("top" === this.verticalAlign || "bottom" === this.verticalAlign) this.orientation = "horizontal", c = this.verticalAlign, f = this.maxWidth = null !== this.maxWidth ? this.maxWidth : d.width, l = this.maxHeight = null !== this.maxHeight ? this.maxHeight :
                0.5 * d.height; else if ("center" === this.verticalAlign) {
            ...
            for (var n = 0; n < this.dataSeries.length; n++) {
                ...
                if (p.dataPoints && p.dataPoints.length) if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !==
                    ...
                    var x = p.dataPoints[y],
                        ...
                        g = this.chart.replaceKeywordsWithValue(g, x, p, y), q = {
                            markerType: q,
                            markerColor: t,
                            text: g,
                            textBlock: null,
                ...
                for (n = 0; n < m.length; n++) {
                    ...
                    if (!(0 >= l || "undefined" === typeof l || 0 >= v || "undefined" === typeof v)) {
                        if ("horizontal" ===
                            ...
                            if (!p || p.width +
                                Math.round(q.textBlock.width + w + h + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f) p = {
                                items: [],
                                width: 0
                        ...
                        q.textBlock.y = 0;
                        p.width += Math.round(q.textBlock.width + w + h + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" ===
        ...
        R.prototype.render = function () {
            ...
            for (var h = 0, r = 0; r < l.length; r++) {
                for (var k = l[r], n = 0, p = 0; p < k.items.length; p++) {
                    var q = k.items[p], g = q.textBlock.x + a + (0 === p ? 0.2 * f : this.horizontalSpacing), m = d + h,
                        w = g;
                    ...
                    if ("line" === q.chartType || "stepLine" === q.chartType ||
                        "spline" === q.chartType) this.ctx.strokeStyle = q.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(g - 0.1 * this.lineHeight, m + this.lineHeight / 2), this.ctx.lineTo(g + 0.85 * this.lineHeight, m + this.lineHeight / 2), this.ctx.stroke(), w -= 0.1 * this.lineHeight;
                    if ("error" === q.chartType) {
                        this.ctx.strokeStyle = this.errorMarkerColor[0];
                        this.ctx.lineWidth = f / 8;
                        this.ctx.beginPath();
                        var v = g - 0.08 * this.lineHeight + 0.1 * this.lineHeight, u = m + 0.15 * this.lineHeight,
                            y = 0.7 * this.lineHeight, x = y +
        ...
        S.prototype.getDataPointAtXY = function (a, d, c) {
            ...
            c = c || !1;
            var b = [], e = 0, f = 0, l = 1, h = !1, r = Infinity, k = 0, n =
                0, p = 0;
            if ("none" !== this.chart.plotInfo.axisPlacement) if (p = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({
                ...
                p = 1 < q ? Math.min(Math.max((this.dataPoints.length - 1) / q * Math.log(p / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0; else q = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, p = 0 < q ? Math.min(Math.max((this.dataPoints.length - 1) / q * (p - this.dataPoints[0].x) >>
                0, 0), this.dataPoints.length) : 0;
            for (; ;) {
                f = 0 < l ? p + e : p - e;
                if (0 <= f && f < this.dataPoints.length) {
                    var q = this.chart._eventManager.objectMap[this.dataPointIds[f]], g = this.dataPoints[f], m = null;
                    if (q) {
                        switch (this.type) {
                            case "column":
                            case "stackedColumn":
                            ...
                            case "splineArea":
                            case "scatter":
                                var w = ma("markerSize", g, this) || 4, v = c ? 20 : w,
        ...
        A.prototype.createLabels = function () {
            ...
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                a || (a = this.labelFormatter ? this.labelFormatter({
                    ...
                    value: new Date(n),
                    label: this.labels[n] ? this.labels[n] : null
                }) : "axisX" === this.type && this.labels[n] ? this.labels[n] : Aa(n, this.valueFormatString, this.chart._cultureInfo),
                    a = new ja(this.ctx, {
                        x: 0,
                        y: 0,
                        maxWidth: f,
            ...
            e = [];
            q = p = 0;
            if (this.labelAutoFit || this.options.labelAutoFit) if (r(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position) if (f = 0.9 * h >> 0, q = 0, !this.chart.panEnabled && 1 <=
            this._labels.length) {
        ...
        A.setLayout = function (a, d, c, b, e, f) {
            ...
            for (g = 0; g < q.length; g++) if (q[g] && q[g].scaleBreaks &&
                q[g].scaleBreaks._appliedBreaks.length) for (var t = q[g].scaleBreaks._appliedBreaks, w = 0; w < t.length && !(t[w].startValue > q[g].viewportMaximum); w++) t[w].endValue < q[g].viewportMinimum || (r(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = w), t[w].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = w));
            for (var v = w = 0, u = 0, y = 0, x = 0, z = 0, A = 0, C, B, E = h = 0, I, J, K, t = I = J = K = !1, g = 0; g < q.length; g++) q[g] && q[g].title && (q[g]._titleTextBlock = new ja(q[g].ctx, {
                text: q[g].title,
                horizontalAlign: "center",
            ...
            if ("normal" === e) {
                ...
                w;) {
                    var F = 0, S = 0, U = 0, W = 0, Y = e = 0, L = 0, Z = 0, V = 0, X = 0, Q = 0, $ = 0;
                    if (c && 0 < c.length) for (z = [], g = Q = 0; g < c.length; g++) z.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), Q += z[g], L += c[g] && !n.isNavigator ? c[g].margin : 0; else z.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
                    P.push(z);
                    if (b && 0 < b.length) for (A = [], g = $ = 0; g < b.length; g++) A.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)), $ += A[g], Z += b[g] ? b[g].margin : 0; else A.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
                    R.push(A);
                    l = Math.round(f.x1 + Q + L);
                    m = Math.round(f.x2 - $ - Z > n.width - p ? n.width - p : f.x2 - $ - Z);
                    if (a && 0 < a.length) for (y = [], g = V = 0; g < a.length; g++) a[g] && (a[g].lineCoordinates = {}), a[g].lineCoordinates.width = Math.abs(m - l), a[g].title && (a[g]._titleTextBlock.maxWidth = 0 < a[g].titleMaxWidth && a[g].titleMaxWidth < a[g].lineCoordinates.width ? a[g].titleMaxWidth : a[g].lineCoordinates.width), y.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateHeight() : 0)), V += y[g], e += a[g] && !n.isNavigator ? a[g].margin : 0; else y.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() :
                        0));
                    N.push(y);
                    if (d && 0 < d.length) for (x = [], g = X = 0; g < d.length; g++) d[g] && (d[g].lineCoordinates = {}), d[g].lineCoordinates.width = Math.abs(m - l), d[g].title && (d[g]._titleTextBlock.maxWidth = 0 < d[g].titleMaxWidth && d[g].titleMaxWidth < d[g].lineCoordinates.width ? d[g].titleMaxWidth : d[g].lineCoordinates.width), x.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateHeight() : 0)), X += x[g], Y += d[g] && !n.isNavigator ? d[g].margin : 0; else x.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateHeight() : 0));
                    O.push(x);
                    ...
                    if (d && 0 < d.length) for (g = 0; g < d.length; g++) d[g].lineCoordinates.x1 = Math.round(f.x1 + Q + L), d[g].lineCoordinates.x2 =
                    ...
                    if (c && 0 < c.length) for (g = 0; g < c.length; g++) L = n.isNavigator ? 0 : 10, c[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2 : p, h = Math.round(f.y1 + X + Y < Math.max(L, p) ? Math.max(L, p) : f.y1 + X + Y), m = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = 0 < a.length ? 0 : c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[0].textBlock.height /
                        2 : p, k = Math.round(f.y2 - V - e - L), c[g].lineCoordinates = {
                        x1: l - U,
                        y1: h,
                        x2: m - U,
                        y2: k,
                    ...
                    c[g].lineCoordinates.height ? c[g].titleMaxWidth : c[g].lineCoordinates.height), U += z[g] + c[g].margin);
                    if (b && 0 < b.length) for (g = 0; g < b.length; g++) b[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), m = Math.round(l), L = b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[b[g]._labels.length - 1].textBlock.height / 2 : 0, h = Math.round(f.y1 + X + Y < Math.max(L, p) ? Math.max(L, p) : f.y1 + X + Y), L = 0 < a.length ? 0 : b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[0].textBlock.height / 2 : 0, k = Math.round(f.y2 - (V + e + L)), b[g].lineCoordinates =
                        {
                            x1: l + W,
                            y1: h,
                            x2: l + W,
                        ...
                        b[g].lineCoordinates.height), W += A[g] + b[g].margin);
                    ...
                    if (d && 0 < d.length) for (g = 0; g < d.length; g++) d[g].calculateValueToPixelConversionParameters(), d[g].calculateBreaksSizeInValues(), d[g]._labels && 1 < d[g]._labels.length && (C = (d[g].logarithmic ?
                    ...
                    if (0 < w) {
                        if (a && 0 < a.length) for (g = 0; g < a.length; g++) t = N[w - 1][g] === N[w][g] ? !0 : !1; else t = !0;
                        if (d && 0 < d.length) for (g = 0; g < d.length; g++) I = O[w - 1][g] === O[w][g] ? !0 : !1; else I = !0;
                        if (c && 0 < c.length) for (g = 0; g < c.length; g++) J = P[w - 1][g] === P[w][g] ? !0 : !1; else J = !0;
                        if (b && 0 < b.length) for (g = 0; g < b.length; g++) K = R[w -
                ...
                for (O = []; 4 > w;) {
                    ...
                    if (a && 0 < a.length) for (E = [], g = W = 0; g < a.length; g++) E.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)), W += E[g], e += a[g] && !n.isNavigator ? a[g].margin : 0; else E.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
                    N.push(E);
                    if (d && 0 < d.length) for (v = [], g = V = 0; g < d.length; g++) v.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateWidth() : 0)), V += v[g], Y += d[g] ? d[g].margin : 0; else v.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() :
                        0));
                    O.push(v);
                    if (c && 0 < c.length) for (g = 0; g < c.length; g++) c[g].lineCoordinates = {}, l = Math.round(f.x1 + W + e), m = Math.round(f.x2 - V - Y > n.width - 10 ? n.width - 10 : f.x2 - V - Y), c[g].labelAutoFit && !r(y) && (0 < !a.length && (l = 0 > c[g].labelAngle ? Math.max(l, y) : 0 === c[g].labelAngle ? Math.max(l, y / 2) : l), 0 < !d.length && (m = 0 < c[g].labelAngle ? m - x / 2 : 0 === c[g].labelAngle ? m - x / 2 : m)), c[g].lineCoordinates.x1 = l, c[g].lineCoordinates.x2 = m, c[g].lineCoordinates.width = Math.abs(m - l), c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth <
                    c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width);
                    if (b && 0 < b.length) for (g = 0; g < b.length; g++) b[g].lineCoordinates = {}, l = Math.round(f.x1 + W + e), m = Math.round(f.x2 - V - Y > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - V - Y), b[g] && b[g].labelAutoFit && !r(z) && (0 < !a.length && (l = 0 < b[g].labelAngle ? Math.max(l, z) : 0 === b[g].labelAngle ? Math.max(l, z / 2) : l), 0 < !d.length && (m -= A / 2)), b[g].lineCoordinates.x1 = l, b[g].lineCoordinates.x2 = m, b[g].lineCoordinates.width = Math.abs(m - l), b[g].title && (b[g]._titleTextBlock.maxWidth =
                    ...
                    B.push(p);
                    if (b && 0 < b.length) for (C = [], g = S = 0; g < b.length; g++) C.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)), S += C[g], Z += b[g].margin; else C.push(Math.ceil(b[0] ?
                        b[0].createLabelsAndCalculateHeight() : 0));
                    u.push(C);
                    if (c && 0 < c.length) for (g = 0; g < c.length; g++) 0 < c[g]._labels.length && (k = c[g]._labels[0], h = c[g]._labels[c[g]._labels.length - 1], y = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), x = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)));
                    ...
                    if (b && 0 < b.length) for (g = b.length - 1; 0 <= g; g--) b[g] && (h = Math.round(f.y1), k = Math.round(f.y1 + (C[g] + b[g].margin + F)), b[g].lineCoordinates.y1 =
                    ...
                    if (a && 0 < a.length) for (g = 0; g < a.length; g++) {
                        ...
                        if (c && 0 < c.length) for (L = 0; L < c.length; L++) c[L] && c[L].labelAutoFit && (m = 0 > c[L].labelAngle ? Math.max(m, y) : 0 === c[L].labelAngle ? Math.max(m, y / 2) : m, l =
                            0 > c[L].labelAngle || 0 === c[L].labelAngle ? m - W : l);
                        if (b && 0 < b.length) for (L = 0; L < b.length; L++) b[L] && b[L].labelAutoFit && (m = b[L].lineCoordinates.x1, l = m - W);
                    ...
                    if (d && 0 < d.length) for (g = 0; g < d.length; g++) {
                        ...
                        k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - U > n.height - Math.max(L, 10) ? n.height - Math.max(L, 10) : f.y2 - U) : f.y2 > n.height - Math.max(L, 10) ? n.height - Math.max(L, 10) : f.y2;
                        if (c && 0 < c.length) for (L = 0; L < c.length; L++) c[L] && c[L].labelAutoFit && (m = 0 > c[L].labelAngle ? Math.max(m, y) : 0 === c[L].labelAngle ? Math.max(m, y / 2) : m, l = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? m - V : l);
                        if (b && 0 < b.length) for (L = 0; L < b.length; L++) b[L] &&
                        b[L].labelAutoFit && (m = b[L].lineCoordinates.x2, l = m - V);
                    ...
                    if (0 < w) {
                        if (a && 0 < a.length) for (g = 0; g < a.length; g++) t = N[w - 1][g] === N[w][g] ? !0 : !1; else t = !0;
                        if (d && 0 < d.length) for (g = 0; g < d.length; g++) I = O[w - 1][g] === O[w][g] ? !0 :
                            !1; else I = !0;
                        if (c && 0 < c.length) for (g = 0; g < c.length; g++) J = B[w - 1][g] === B[w][g] ? !0 : !1; else J = !0;
                        if (b && 0 < b.length) for (g = 0; g < b.length; g++) K = u[w - 1][g] === u[w][g] ? !0 : !1; else K = !0
                    }
                    if (t && I && J && K) break;
                    w++
                }
        ...
        A.prototype.renderAxisLine = function () {
            ...
            if ("bottom" === this._position || "top" === this._position) {
                if (this.lineThickness) {
                    ...
                    d.beginPath();
                    if (this.scaleBreaks && !r(this.scaleBreaks.firstBreakIndex)) if (r(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + b; else for (var h = this.scaleBreaks.firstBreakIndex; h <= this.scaleBreaks.lastBreakIndex; h++) d.moveTo(e,
        ...
        $.prototype.render = function (a) {
            if (0 !== this.spacing ||
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position) if (b = 1 === p % 2 ? (b.x << 0) + 0.5 : b.x << 0, l = 1 === p % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, h = this.chart.plotArea.y2 +
        ...
        ca.prototype.render = function (a, d, c) {
            var b, e, f, h, m = null, w = null, k = null, n = "";
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    var v = null;
                    if ("bottom" === this.parent._position || "top" === this.parent._position) t = this.parent.dataSeries[0].axisX.convertPixelToValue({y: d}); else if ("left" === this.parent._position || "right" === this.parent._position) t = this.parent.convertPixelToValue({y: d});
                    ...
                    B = 0;
                    if ("rangeBar" === n[0].dataSeries.type || "error" === n[0].dataSeries.type) for (var v = Math.abs(a - this.parent.convertValueToPixel(n[B].dataPoint.y[0])), u = 0, t = 0; t < n.length; t++) if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (var y = 0; y < n[t].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < v && (v = u, B = t); else u =
                        ...
                        Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), z = x = u = 0, t = 0; t < n.length; t++) if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (y = 0; y < n[t].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < v && (v = u, B = t); else x += n[t].dataPoint.y, z = n[t].dataPoint.x.getTime ? n[t].dataPoint.x.getTime() : n[t].dataPoint.x, z = 100 * (x / n[t].dataSeries.plotUnit.dataPointYSums[z]), u = Math.abs(a - this.parent.convertValueToPixel(z)), u < v && (v = u, B = t); else for (v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     t = B = u = 0; t < n.length; t++) if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (y = 0; y < n[t].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < v && (v = u, B = t); else u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y)), u < v && (v = u, B = t);
                    y = n[B];
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[B].type || "error" === this.parent.dataSeries[B].type) {
                            ...
                            }) : r(this.options.label) ? da(r(c) ? y.dataPoint.y[b] : c, this.valueFormatString, this.chart._cultureInfo) :
                                this.label
                        } else if ("stackedBar" === this.parent.dataSeries[B].type) {
                            v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y));
                            x = u = 0;
                            for (t = B; 0 <= t; t--) x += n[t].dataPoint.y, u = Math.abs(a - this.parent.convertValueToPixel(x)), u < v && (v = u, b = t);
                            ...
                            v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y));
                            z = x = u = 0;
                            for (t = B; 0 <= t; t--) x += n[t].dataPoint.y, z = n[t].dataPoint.x.getTime ? n[t].dataPoint.x.getTime() : n[t].dataPoint.x, z = 100 * (x / n[t].dataSeries.plotUnit.dataPointYSums[z]), u = Math.abs(a - this.parent.convertValueToPixel(z)), u < v && (v = u, b = t);
                        ...
                        z = !1;
                        if (this.parent.labels) for (n = Math.ceil(this.parent.interval), t = 0; t < this.parent.viewportMaximum; t +=
                            n) if (this.parent.labels[t]) z = !0; else {
                            z = !1;
                            break
                        }
                        if (z) {
                    ...
                    for (B = 0; B < this.parent.dataSeries.length; B++) (v =
                        this.parent.dataSeries[B].getDataPointAtX(t, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[B], null !== v.dataPoint.y && v.dataSeries.visible && n.push(v));
                    if (0 === n.length) return;
                    n.sort(function (a, b) {
                        return a.distance - b.distance
                    });
                    ...
                    if (this.parent.labels) for (n = Math.ceil(this.parent.interval),
                                                     t = 0; t < this.parent.viewportMaximum; t += n) if (this.parent.labels[t]) z = !0; else {
                        z = !1;
                        break
                    }
                    if (z) {
                        if ("axisX" === this.parent.type) for (t = this.parent.convertPixelToValue({x: a}), v = null, B = 0; B < this.parent.dataSeries.length; B++) (v = this.parent.dataSeries[B].getDataPointAtX(t, !0)) && 0 <= v.index && (k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: y.dataPoint.x
                    ...
                    for (B = 0; B < this.parent.dataSeries.length; B++) (v = this.parent.dataSeries[B].getDataPointAtX(t, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[B], null !== v.dataPoint.y && v.dataSeries.visible && n.push(v));
                    if (0 === n.length) return;
                    n.sort(function (a, b) {
                        return a.distance - b.distance
                    });
                    ...
                    if ("rangeColumn" === n[0].dataSeries.type || "rangeArea" === n[0].dataSeries.type || "error" === n[0].dataSeries.type || "rangeSplineArea" === n[0].dataSeries.type || "candlestick" === n[0].dataSeries.type || "ohlc" === n[0].dataSeries.type ||
                        ...
                        Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < v && (v = u, B = t); else u = Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y)), u < v && (v = u, B = t);
                    y = n[B];
                    b = 0;
                    if ("rangeColumn" === this.parent.dataSeries[B].type || "rangeArea" === this.parent.dataSeries[B].type || "error" === this.parent.dataSeries[B].type || "rangeSplineArea" === this.parent.dataSeries[B].type || "candlestick" === this.parent.dataSeries[B].type || "ohlc" === this.parent.dataSeries[B].type || "boxAndWhisker" === this.parent.dataSeries[B].type) {
                        ...
                        k.text = this.labelFormatter ? this.labelFormatter({
                            ...
                            crosshair: this.options,
                            value: y.dataPoint.y[b]
                        }) : r(this.options.label) ? da(r(c) ? y.dataPoint.y[b] : c, this.valueFormatString,
                        ...
                        x = u = 0;
                        for (t = B; 0 <= t; t--) x += n[t].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(x)), u < v && (v = u, b = t);
                        ...
                        v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y));
                        x = u = 0;
                        for (t = B; 0 <= t; t--) x += n[t].dataPoint.y, z = n[t].dataPoint.x.getTime ? n[t].dataPoint.x.getTime() : n[t].dataPoint.x, z = 100 * (x / n[t].dataSeries.plotUnit.dataPointYSums[z]),
                    ...
                    }) : r(this.options.label) ? da(r(c) ? y.dataSeries.dataPointEOs[y.index].cumulativeSum : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = y.dataSeries.dataPointEOs[y.index].cumulativeSum) : (w = 1 === q.lineWidth % 2 ? (r(a) ? d : this.parent.convertValueToPixel(y.dataPoint.y) <<
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) if ("left" ===
                    ...
                    z = !1;
                    if (this.parent.labels) for (n = Math.ceil(this.parent.interval), t = 0; t < this.parent.viewportMaximum; t += n) if (this.parent.labels[t]) z = !0; else {
                        z = !1;
                        break
                    }
                    if (z) {
                    ...
                    z = !1;
                    n = "";
                    if (this.parent.labels) for (n = Math.ceil(this.parent.interval), t = 0; t < this.parent.viewportMaximum; t += n) if (this.parent.labels[t]) z =
                        !0; else {
                        z = !1;
                        break
                    }
                    if (z) {
                        ...
                        da(r(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label);
                    k.x = b - k.measureText().width / 2;
                    k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.width);
                    k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1);
                    "bottom" === this.parent._position ? k.y = this.parent.lineCoordinates.y2 + k.fontSize / 2 + 2 : "top" === this.parent._position && (k.y = this.parent.lineCoordinates.y1 - k.height + k.fontSize / 2 + 2)
        ...
        Z.prototype._initialize = function () {
            ...
            if (this.enabled) {
                ...
                w || (a.style.filter = "alpha(opacity = 90)", a.style.filter = "progid:DXImageTransform.Microsoft.Shadow(Strength=3, Direction=135, Color='#ed3b3b')");
        ...
        Z.prototype._updateToolTip = function (a, d, c) {
            ...
            if (!this.chart.disableToolTip) {
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    ...
                    if (b = this.chart.getDataPointAtXY(a, d, c)) this.currentDataPointIndex = b.dataPointIndex, this.currentSeriesIndex = b.dataSeries.index; else if (w) if (b = Za(a, d, this.chart._eventManager.ghostCtx), 0 < b && "undefined" !== typeof this.chart._eventManager.objectMap[b]) {
        ...
        Z.prototype.showAtX = function (a, d) {
            ...
            if (this.shared) for (var h = 0; h < this.chart.data.length; h++) c = this.chart.data[h], (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !r(b.dataPoint.y) && c.visible) && (b.dataSeries = c, f.push(b)); else c = this.chart.data[d], (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !r(b.dataPoint.y) && c.visible) && (b.dataSeries = c, f.push(b));
            if (0 < f.length) {
                ...
                if (null !== h) {
                    ...
                    if (this.isToolTipDefinedInData &&
                        r(this.options.content) && r(this.options.contentFormatter)) for (b = this.contentDiv.getElementsByTagName("span"), h = 0; h < b.length; h++) b[h] && (b[h].style.color = b[h].getAttribute("data-color"));
                    h = !1;
        ...
        ha.prototype.getNewObjectTrackingId =
            function () {
