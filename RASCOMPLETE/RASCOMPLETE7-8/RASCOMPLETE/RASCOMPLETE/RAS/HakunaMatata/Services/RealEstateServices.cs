    ...
    public class RealEstateServices : IRealEstateServices
    {
        ...
        public List<VM_RealEstate> GetList()
        {
            ...
            foreach (var item in details)
            {
                var vm_rt = new VM_RealEstate()
                {
                    ...
                    IsConfirm = item.RealEstate.IsConfirm,
                };
        ...
        public List<VM_WishList> GetWishList(string agentId)
        {
            ...
            var wishlist = _context.Wishlist
                ...
                .GroupBy(x => new { x.Wishlist.Id, x.Wishlist.RealEstateId, x.RealEstateDetail.Title, x.RealEstateDetail.Price, x.Map.Address ,x.RealEstateDetail.RoomNumber})
        ...
        public int AddCompleteRealEstate(VM_RealEstateDetails details, int agentId)
        {
            ...
            if (realEstateId != -1)
            {
                ...
                var rtDetails = new RealEstateDetail()
                {
                    ...
                    Acreage = (int)(details?.Acreage),
                    RoomNumber = (int)details.RoomNumber,
                    Description = details.Description,
                    HasPrivateWc = details.HasPrivateWc,
                    HasMezzanine = details.HasMezzanine,
                    AllowCook = details.AllowCook,
        ...
        public bool UpdateRealEstate(VM_RealEstateDetails details)
        {
            ...
            if (rt != null)
            {
                ...
                if (rt_detail != null)
                {
                    ...
                    rt_detail.Price = (decimal)details.Price;
                    rt_detail.Acreage = (int)details.Acreage;
                    rt_detail.RoomNumber = (int)details.RoomNumber;
